...
It has been tested on exome, genome, and panel sequencing data from CMG/GREGoR rare disease cohorts as well as on exomes and genomes from the UK Biobank (UKBB). In these tests, SMA Finder's false positive rate was less than 1 in 200,000, its true positive rate was 28/28 (100%), and its positive predictive value (PPV) was 97%. 
